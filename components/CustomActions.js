...
render() {
    return (
      <>
      <TouchableOpacity accesssible={true} accessibilityLabel="more options" accessibilityHint='lets you send  image or location' accessibilityRole='button' style={[styles.container]} onPress={this.onActionPress}>
